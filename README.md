...
- JVM `Code` attribute parsing with method-level invocation tracing and sensitive-call evidence
...
1. Data-flow analysis for values passed into sensitive calls
